            ...
            <Fragment>
                <div className={style.firstScreen}>
                    ...
                    <h1
                        ...
                        dangerouslySetInnerHTML={{ __html: t('headings.BTCUStore') }}
                    />
                    <h3 className={style.firstScreen__subTitle}>
                        {t('texts.storeConstruction')}
                    </h3>
                ...
                <div className={style.container}>
                    <div className={style.container__wrapper}>
                        <h2 className={style.container__title}>{t('headings.market')}</h2>
